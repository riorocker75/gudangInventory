           ...
           <div class="card">
                <div class="card-header">
                  ...
                  <div class="float-right">
                      ...
                      <a href="#" class="btn btn-default" data-toggle="modal" data-target="#cetakLaporanMasuk"> <i class="fa fa-print" aria-hidden="true"></i> Cetak Laporan</a>
...
<div class="modal fade" id="cetakLaporanMasuk" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <form method="post" action="{{url('/dashboard/barang_masuk/cetak')}}" enctype="multipart/form-data">
